...
export interface CategoryService {
	...
	create: (newCategoryData: NewCategory) => Promise<Category | "NO_CATEGORY_CREATED">;
	update: (id: string, updateCategoryData: UpdateCategory) => Promise<Category | "CATEGORY_NOT_FOUND">;
